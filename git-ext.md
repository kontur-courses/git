...
3. Через VS Code создай файл `init.md` со следующим содержимым (здесь и далее копировать
...
```
4. Открой репозиторий, убедись, что в нем есть коммит с названием `Initial commit`
5. Нажми кнопку `Commit`, чтобы открыть окно коммита
6. Переведи `init.md` из верхней части в нижнюю часть окна кнопкой `Stage` либо двойным нажатием по имени файла.
Теперь `init.md` находится в `Commit index`
7. Введи в качестве сообщения к коммиту `Add init.md` и сделай коммит кнопкой `Commit`
8. Убедись, что коммит появился в истории коммитов
...
```
10. Выбери в истории коммитов `Working directory` и убедись, что там есть измененный файл `commit.md`
11. Открой окно коммита и переведи `commit.md` в `Commit index` и закрой окно коммита
12. Выбери в истории коммитов `Commit index` и убедись, что измененный файл `commit.md` теперь находится там
...
[Правильное дерево коммитов для этого этапа](https://raw.githubusercontent.com/kontur-courses/git/master/assets/solved-screenshots/4-ext.png)
...
[Правильное дерево коммитов для этого этапа](https://raw.githubusercontent.com/kontur-courses/git/master/assets/solved-screenshots/7-ext.png)
...
[Правильное дерево коммитов для этого этапа](https://raw.githubusercontent.com/kontur-courses/git/master/assets/solved-screenshots/11-ext.png)
...
[Правильное дерево коммитов для этого этапа](https://raw.githubusercontent.com/kontur-courses/git/master/assets/solved-screenshots/16-ext.png)